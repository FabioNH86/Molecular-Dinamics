...
n_monomeros_totales = 120000  # Total de monómeros en el sistema (ajustar según tu simulación)
...
print(f"Parámetros fijos: {n_monomeros_totales} monómeros totales y {n_solvente} partículas de solvente (Conc. = 1.0%).")
